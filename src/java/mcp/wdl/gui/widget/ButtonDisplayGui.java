...
public class ButtonDisplayGui extends WDLButton {
	 ...
	 */
	public ButtonDisplayGui(int x, int y, int widthIn, int heightIn, GuiScreen screen) {
	 ...
	 */
	public ButtonDisplayGui(int x, int y, int widthIn, int heightIn, String buttonText, GuiScreen screen) {

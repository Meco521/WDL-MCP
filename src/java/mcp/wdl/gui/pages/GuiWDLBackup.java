...
public class GuiWDLBackup extends WDLScreen {
	...
	public GuiWDLBackup(GuiScreen parent, WDL wdl) {
	...
	public void initGui() {
		backupTypeButton = this.addButton(new WDLButton(this.width / 2 - 100, 32,
			...
			public @Override void performAction() {
				switch (backupType) {
					case NONE:
						backupType = WorldBackup.WorldBackupType.FOLDER;
						break;
					case FOLDER:
						backupType = WorldBackup.WorldBackupType.ZIP;
						break;
					case ZIP:
						backupType = WorldBackup.WorldBackupType.CUSTOM;
						break;
					case CUSTOM:
						backupType = WorldBackup.WorldBackupType.NONE;
						break;
				}
	...
	private void updateFieldVisibility() {
		boolean isCustom = (backupType == WorldBackup.WorldBackupType.CUSTOM);

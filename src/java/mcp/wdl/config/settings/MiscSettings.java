...
import mcp.wdl.config.BaseSetting;
import mcp.wdl.config.IConfiguration;
import mcp.wdl.config.Setting;
import mcp.wdl.config.StringSetting;
...
public final class MiscSettings {
	...
	// Backup
	public static final Setting<WorldBackup.WorldBackupType> BACKUP_TYPE =
			new BaseSetting<>("Backup", WorldBackup.WorldBackupType.ZIP, WorldBackup.WorldBackupType::valueOf, WorldBackup.WorldBackupType::name);

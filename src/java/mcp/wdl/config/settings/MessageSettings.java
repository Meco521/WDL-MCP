...
public final class MessageSettings {
	...
	public static class MessageCategorySetting implements CyclableSetting<Boolean> {
		...
		@Override
		public IChatComponent getButtonText(Boolean curValue) {
			return new ChatComponentTranslation("wdl.gui.messages.group." + curValue);
		}
	...
	public static class MessageTypeSetting implements CyclableSetting<Boolean> {
		 ...
		 */
		public MessageTypeSetting(WDLMessages.MessageRegistration typeRegistration) {
		...
		@Override
		public IChatComponent getButtonText(Boolean curValue) {
			return new ChatComponentTranslation("wdl.gui.messages.message." + curValue, registration.type.getDisplayName());
		}

...
public final class PlayerSettings {
	...
	public enum Health implements IStringSerializable {
		...
		private static final Map<String, Health> FROM_STRING = Utils.makeFromString(values(), t -> t.confName);
	...
	public enum Hunger implements IStringSerializable {
		...
		private final String confName;
		private static final Map<String, Hunger> FROM_STRING = Utils.makeFromString(values(), t -> t.confName);
	...
	public enum PlayerPos implements IStringSerializable {
		...
		private final String confName;
		private static final Map<String, PlayerPos> FROM_STRING = Utils.makeFromString(values(), t -> t.confName);

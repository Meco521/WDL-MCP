 ...
 */
package mcp.wdl.config.settings;

import java.util.Map;

import mcp.wdl.config.BooleanSetting;
import mcp.wdl.config.EnumSetting;
import mcp.wdl.config.IConfiguration;
import mcp.wdl.config.IntSetting;
...
public final class WorldSettings {
	...
	public enum GameMode implements IStringSerializable {
		...
		private static final Map<String, GameMode> FROM_STRING = Utils.makeFromString(values(), t -> t.confName);
	...
	public enum Weather implements IStringSerializable {
		...
		private final String confName;
		private static final Map<String, Weather> FROM_STRING = Utils.makeFromString(values(), t -> t.confName);
	...
	public enum SpawnMode implements IStringSerializable {
		...
		private final String confName;
		private static final Map<String, SpawnMode> FROM_STRING = Utils.makeFromString(values(), t -> t.confName);
	...
	public enum Time implements IStringSerializable {
		...
		private final String confName;
		private static final Map<String, Time> FROM_STRING = Utils.makeFromString(values(), t -> t.confName);
	...
	public enum Difficulty implements IStringSerializable {
		...
		private final String confName;
		private static final Map<String, Difficulty> FROM_STRING = Utils.makeFromString(values(), d -> d.confName);

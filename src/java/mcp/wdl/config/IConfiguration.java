...
public interface IConfiguration {
	 ...
	 */
	public default <T> IChatComponent getButtonText(CyclableSetting<T> setting) {
	 ...
	 */
	public abstract void setUserEntityTrackDistance(String entityType, int value);

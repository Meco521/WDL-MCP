...
public class EntityUtils {
	 ...
	 * @return
	 */
	public static int getEntityTrackDistance(TrackDistanceMode mode, String type, Entity entity) {
		switch (mode) {
		case DEFAULT: {
			for (IEntityManager manager : getEntityManagers()) {

...
import mcp.wdl.gui.pages.GuiTurningCameraBase;
...
import mcp.wdl.MapDataHandler.MapDataResult;
import mcp.wdl.api.IBlockEventListener;
import mcp.wdl.api.IChatMessageListener;
import mcp.wdl.api.IGuiHooksListener;
import mcp.wdl.api.IWorldLoadListener;
import mcp.wdl.api.WDLApi;
import mcp.wdl.api.WDLApi.ModInfo;
import mcp.wdl.config.settings.GeneratorSettings;
import mcp.wdl.functions.MapFunctions;
import mcp.wdl.gui.pages.GuiWDL;
import mcp.wdl.gui.pages.GuiWDLAbout;
import mcp.wdl.gui.widget.WDLButton;
import mcp.wdl.handler.HandlerException;
import mcp.wdl.handler.block.BlockHandler;
import mcp.wdl.handler.blockaction.BlockActionHandler;
import mcp.wdl.handler.entity.EntityHandler;
...
public class WDLEvents {
	 ...
	 * the map item.
	 */
	public void onMapDataLoaded(int mapID, MapData mapData) {
		if (!WDL.downloading) { return; }
	...
	private static class HooksListener implements WDLHooks.IHooksListener {
		...
		public void injectWDLButtons(GuiIngameMenu gui, Collection<GuiButton> buttonList,
			...
			addButton.accept(new StartDownloadButton(gui,
					gui.width / 2 - 100, gui.height / 4 + 48 + 8, 170, 20));

			addButton.accept(new SettingsButton(gui,
					gui.width / 2 + 72, gui.height / 4 + 48 + 8, 28, 20,

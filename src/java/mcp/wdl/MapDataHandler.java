...
public final class MapDataHandler {
	 ...
	 */
	public static MapDataResult repairMapData(int mapID, MapData mapData, EntityPlayer player) {
	...
	private static boolean isMapWithID(ItemStack stack, int mapID) {
		if (stack == null) {
	...
	public static class MapDataResult {
		MapDataResult(MapData map, Entity confirmedOwner, Vec4b decoration) {
			this.map = map;
